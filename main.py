...
@tool
def calorie_count(user_input: str) -> str:
...
def generate_diet_plan(calories: float, follow_up: dict) -> dict:
    """Generate a diet plan based on calorie count and user answers."""
    diet_plan = {
...
while True:
    ...
    # Generate diet plan based on calorie output and follow-up answers
    diet_plan = generate_diet_plan(float(calorie_output), follow_up_answers)
